# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-11-06 15:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='default.pan', max_length=255, upload_to='image/%Y/%m/%d', verbose_name='头像')),
        ...
        migrations.AddField(
            model_name='content',
            name='type_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='context', to='lle.Type', verbose_name='新闻类型'),
        ),
        migrations.AddField(
            model_name='content',
            name='user_id',
        ...
        migrations.AddField(
            model_name='comment',
            name='news_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comment', to='lle.Content', verbose_name='评论文章'),
        ),
        migrations.AddField(
            model_name='comment',
            name='restore',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='lle.Comment', verbose_name='回复对象'),
        ),
        migrations.AddField(
            model_name='comment',
            name='restore_user',
