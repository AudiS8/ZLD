...
class UserInfo(AbstractUser):
    ...
    image = models.ImageField(upload_to='image/%Y/%m/%d', default='default.pan', max_length=255, verbose_name='头像')
...
class Content(models.Model):
    ...
    image = models.ImageField(upload_to="image/%Y/%m", default='default.png', max_length=255, verbose_name="文章图片")
    publish = models.DateTimeField(default=datetime.now, verbose_name='发布时间')
...
#     ip = models.GenericIPAddressField(verbose_name='用户 IP 地址')
#
#     def __str__(self):
#         return '%s' % self.id
#
